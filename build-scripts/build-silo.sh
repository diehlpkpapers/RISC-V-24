...
DOWNLOAD_URL="https://github.com/LLNL/Silo/releases/download/${SILO_VERSION}/silo-${SILO_VERSION}.tar.xz"
...
if [[ ! -d ${DIR_SRC} ]]; then
    (
        ...
        cd ${DIR_SRC}
        wget  ${DOWNLOAD_URL}
       	tar -xf silo-${SILO_VERSION}.tar.xz
...
(
    ...
    ./configure --prefix=${DIR_INSTALL} --with-hdf5=$INSTALL_ROOT/hdf5/include,$INSTALL_ROOT/hdf5/lib --enable-optimization --build=riscv64-unknown-linux-gnu 
